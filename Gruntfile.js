// Generated on 2014-11-25 using generator-ionic 0.6.1
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            js: {
                ...
                tasks: ['newer:copy:app', 'newer:jshint:all', 'injector:scripts']
            },
            compass: {
    ...
    grunt.registerTask('serve', function (target) {
        if (target === 'compress') {
            return grunt.task.run(['compress', 'injector:scripts', 'ionic:serve']);
        }
